// These are demo/concept projects built to show design and development range —
// not real client work. Each is clearly labelled "Demo Concept" in the UI.
//
// REPLACE: swap `image` for your own screenshot/mockup once you have real
// project photography. `demoUrl` points at the live in-app demo routes
// defined in src/App.jsx — update these paths if you rename those routes.
